import{A as k,S as x,a as S,i as E}from"./assets/vendor-951662e8.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const m=[{src:"./img/My-project/js-jpg/energy.jpg",retina:"./img/My-project/js-jpg/energy-2x.jpg",alt:"Energy Flow Webservice"},{src:"./img/My-project/js-jpg/fruitbox.jpg",retina:"./img/My-project/js-jpg/fruitbox-2x.jpg",alt:"fruitbox online store"},{src:"./img/My-project/js-jpg/jewelry.jpg",retina:"./img/My-project/js-jpg/jewelry-2x.jpg",alt:"chego jewelry website"},{src:"./img/My-project/js-jpg/mimino.jpg",retina:"./img/My-project/js-jpg/mimino-2x.jpg",alt:"mimino website"},{src:"./img/My-project/js-jpg/power.jpg",retina:"./img/My-project/js-jpg/power-2x.jpg",alt:"power pulse webservice"},{src:"./img/My-project/js-jpg/starlight.jpg",retina:"./img/My-project/js-jpg/starlight-2x.jpg",alt:"starlight studio landing page"},{src:"./img/My-project/js-jpg/vyshyvanka.jpg",retina:"./img/My-project/js-jpg/vyshyvanka-2x.jpg",alt:"vyshyvanka vibes Landing Page"}],j=document.querySelector(".load-more-btn"),q=document.querySelector(".image-list");let d=0;j.addEventListener("click",M);function M(){I()}function I(){for(let e=0;e<3;e++){if(d>=m.length){j.style.display="none";return}q.insertAdjacentHTML("beforeend",$(m[d])),d++}}function $(e){return`
        ...
        `}const P=new k(".accordion-container");P.open(0);let c=document.querySelector(".ac.is-open");const u=document.querySelector(".ac:first-child");u.classList.add("is-open");u.style.backgroundColor="rgba(0, 176, 104, 0.2)";u.style.borderRadius="16px";const _=document.querySelectorAll(".ac-trigger");_.forEach((e,o)=>{e.addEventListener("click",()=>{const t=e.closest(".ac");t.classList.contains("is-open")||(c&&!c.classList.contains("ac:first-child")&&(c.classList.remove("is-open"),c.style.backgroundColor="",c.style.borderRadius=""),c=t),t.classList.toggle("is-open"),t.classList.contains("is-open")?(t.style.backgroundColor="rgba(0, 176, 104, 0.2)",t.style.borderRadius="16px"):(t.style.backgroundColor="",t.style.borderRadius="")})});const f=document.querySelector(".burger"),v=document.querySelector(".header-nav"),B=document.querySelectorAll(".nav-menu-item a"),p=document.querySelector(".header"),b=document.querySelector(".night-mode-checkbox");f.addEventListener("click",()=>{v.classList.toggle("active"),f.classList.toggle("active")});B.forEach(e=>{e.addEventListener("click",()=>{v.classList.remove("active")})});const h=localStorage.getItem("theme");h&&h==="dark"&&(p.classList.add("dark-mode"),b.checked=!0);b.addEventListener("change",e=>{e.target.checked?(p.classList.add("dark-mode"),localStorage.setItem("theme","dark")):(p.classList.remove("dark-mode"),localStorage.setItem("theme","light"))});async function N(){const t="https://portfolio-js.b.goit.study/api/reviews";try{return(await S.get(t)).data}catch(i){throw console.error("Error fetching data from API",i),i}}function O(e){return e.map(o=>`
    ...
    `).join("")}async function C(){try{const e=await N(),o=O(e),t=document.querySelector(".swiper-wrapper");t.innerHTML=o;const i=new x(".swiper-container",{loop:!1,navigation:{nextEl:".button-next",prevEl:".button-prev"},breakpoints:{320:{slidesPerView:1,spaceBetween:10},768:{slidesPerView:1,spaceBetween:20},1280:{slidesPerView:2,spaceBetween:32}},centeredSlides:!1,slidesPerView:"auto",keyboard:{enabled:!0,onlyInViewport:!1}});i.on("slideChange",function(){y(i)}),y(i)}catch{iziToast.error({title:"Error",message:"Not found",position:"topRight"})}}function y(e){const{isBeginning:o,isEnd:t}=e,i=document.querySelector(".button-prev"),s=document.querySelector(".button-next"),r=document.querySelector(".icon-prev"),n=document.querySelector(".icon-next");o?(i.classList.add("swiper-button-disabled"),r.classList.add("swiper-icon-disabled")):(i.classList.remove("swiper-button-disabled"),r.classList.remove("swiper-icon-disabled")),t?(s.classList.add("swiper-button-disabled"),n.classList.add("swiper-icon-disabled")):(s.classList.remove("swiper-button-disabled"),n.classList.remove("swiper-icon-disabled"))}document.addEventListener("DOMContentLoaded",C);function A(){const e=document.querySelector(".work-together__form");e.addEventListener("submit",o);function o(t){t.preventDefault();const i=t.target.email.value,s=t.target.message.value,r="https://portfolio-js.b.goit.study/api/requests",n={email:i,comment:s},l=document.querySelector(".work-together__backdrop"),w=document.querySelector(".modal__close"),L=document.querySelector(".work-together__backdrop");fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(a=>{if(!a.ok)throw new Error("Network response was not ok");return a.json()}).then(a=>{l.classList.add("active"),w.addEventListener("click",()=>{l.classList.remove("active")}),L.addEventListener("click",g=>{g.target===g.currentTarget&&l.classList.remove("active")}),e.reset()}).catch(a=>{E.error({title:"Error",message:a.message,backgroundColor:"#de4f69",iconColor:"#ffffff",messageColor:"#fff"})})}}A();
