import{A as E,S as P,a as j,i as q}from"./assets/vendor-951662e8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();const I="/Portfolio-Group-13/assets/energy-1dd075ef.jpg",G="/Portfolio-Group-13/assets/energy-2x-0b723d78.jpg",B="/Portfolio-Group-13/assets/fruitbox-3666c205.jpg",R="/Portfolio-Group-13/assets/fruitbox-2x-5983be8c.jpg",_="/Portfolio-Group-13/assets/jewelry-b69487e0.jpg",N="/Portfolio-Group-13/assets/jewelry-2x-2129e382.jpg",O="/Portfolio-Group-13/assets/mimino-fa2c5b59.jpg",A="/Portfolio-Group-13/assets/mimino-2x-32e1b76a.jpg",T="/Portfolio-Group-13/assets/power-2d59559c.jpg",C="/Portfolio-Group-13/assets/power-2x-fe48c942.jpg",M="/Portfolio-Group-13/assets/starlight-690dd13b.jpg",V="/Portfolio-Group-13/assets/starlight-2x-11132803.jpg",D="/Portfolio-Group-13/assets/vyshyvanka-3183c7ab.jpg",F="/Portfolio-Group-13/assets/vyshyvanka-2x-028b95ab.jpg",J="/Portfolio-Group-13/assets/symbol-defs-5e1a483c.svg",h=[{src:`${I}`,retina:`${G}`,alt:"Energy Flow Webservice"},{src:`${B}`,retina:`${R}`,alt:"fruitbox online store"},{src:`${_}`,retina:`${N}`,alt:"chego jewelry website"},{src:`${O}`,retina:`${A}`,alt:"mimino website"},{src:`${T}`,retina:`${C}`,alt:"power pulse webservice"},{src:`${M}`,retina:`${V}`,alt:"starlight studio landing page"},{src:`${D}`,retina:`${F}`,alt:"vyshyvanka vibes Landing Page"}],w=document.querySelector(".load-more-btn"),z=document.querySelector(".image-list");let d=0;w.addEventListener("click",H);function H(){U()}function U(){for(let e=0;e<3;e++){if(d>=h.length){w.style.display="none";return}z.insertAdjacentHTML("beforeend",W(h[d])),d++}}function W(e){return`
        ...
        `}const K=new E(".accordion-container"),g=document.querySelector(".ac:first-child");g.style.backgroundColor="rgba(0, 176, 104, 0.2)";g.style.borderRadius="16px";K.open(0);let c=g;const Q=document.querySelectorAll(".ac-trigger");Q.forEach(e=>{e.addEventListener("click",()=>{const t=e.closest(".ac");c!==t&&(c.style.backgroundColor="",c.style.borderRadius=""),t.style.backgroundColor="rgba(0, 176, 104, 0.2)",t.style.borderRadius="16px",c=t})});const u=document.querySelector(".burger"),k=document.querySelector(".header-nav"),X=document.querySelectorAll(".nav-menu-item a"),m=document.querySelector(".header"),L=document.querySelector(".night-mode-checkbox");u.addEventListener("click",()=>{k.classList.toggle("active"),u.classList.toggle("active")});X.forEach(e=>{e.addEventListener("click",()=>{k.classList.remove("active"),u.classList.remove("active")})});const v=localStorage.getItem("theme");v&&v==="dark"&&(m.classList.add("dark-mode"),L.checked=!0);L.addEventListener("change",e=>{e.target.checked?(m.classList.add("dark-mode"),localStorage.setItem("theme","dark")):(m.classList.remove("dark-mode"),localStorage.setItem("theme","light"))});async function Y(){const i="https://portfolio-js.b.goit.study/api/reviews";try{return(await j.get(i)).data}catch(r){throw console.error("Error fetching data from API",r),r}}function Z(e){return e.map(t=>`
